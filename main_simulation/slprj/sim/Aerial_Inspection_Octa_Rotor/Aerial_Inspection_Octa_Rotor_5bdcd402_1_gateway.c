...
#endif
#include "nesl_rtw.h"
#include "Aerial_Inspection_Octa_Rotor_5bdcd402_1.h"
#include "Aerial_Inspection_Octa_Rotor_5bdcd402_1_gateway.h"
void Aerial_Inspection_Octa_Rotor_5bdcd402_1_gateway ( void ) {
NeModelParameters modelparams = { ( NeSolverType ) 0 , 0.001 , 1 , 0 , 0.001
, 0 , 0 , 0 , 0 , ( SscLoggingSetting ) 0 , 574255430 , } ;
...
NULL ; NeDae * dae ; size_t numOutputs = 0 ; int * rtpDaes = NULL ; { static
const NeOutputParameters outputparameters_init [ ] = { { 0 , 0 , } , { 0 , 1
, } , } ; outputparameters = outputparameters_init ; numOutputs = sizeof (
outputparameters_init ) / sizeof ( outputparameters_init [ 0 ] ) ; }
Aerial_Inspection_Octa_Rotor_5bdcd402_1_dae ( & dae , & modelparams , &
solverparams ) ; nesl_register_simulator_group (
"Aerial_Inspection_Octa_Rotor/Solver Configuration_1" , 1 , & dae , &

...
MODEL                   = rtwshared
MODULES                 = binsearch_u32d.c binsearch_u32d_prevIdx.c intrp_NSplcd.c look1_binlxpw.c look_SplNBinSScd.c look_SplNBinSZcd.c plook_binx.c plook_binxp.c pm_printf.c rtGetInf.c rtGetNaN.c rt_Spline2Derivd.c rt_backsubrr_dbl.c rt_forwardsubrr_dbl.c rt_lu_real.c rt_matrixlib_dbl.c rt_nonfinite.c RandSrcCreateSeeds_64.c RandSrcInitState_U_64.c RandSrc_U_D.c atan_NHvdu6PS.c iseq_sJSIRDHq.c norm_Yd2SRzkc.c sqrt_JVgK17Mi.c xzlartg_F9md8Q7e.c

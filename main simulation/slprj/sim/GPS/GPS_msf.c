...
#endif
static void mdlInitializeConditions ( SimStruct * S ) { nr2eaj2q25j * dw = (
nr2eaj2q25j * ) ssGetDWork ( S , 0 ) ; gudr0o4fcj ( & ( dw -> rtdw ) ) ; }
static void mdlReset ( SimStruct * S ) { nr2eaj2q25j * dw = ( nr2eaj2q25j * )
ssGetDWork ( S , 0 ) ; fcfwc5pmgc ( & ( dw -> rtdw ) ) ; } static void
mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { nr2eaj2q25j * dw = (
nr2eaj2q25j * ) ssGetDWork ( S , 0 ) ; real_T const * i_pnufqmhe02 = ( real_T
* ) ssGetInputPortSignal ( S , 0 ) ; real_T * o_B_1_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; real_T * o_o_B_1_2 = ( real_T * )
ssGetOutputPortSignal ( S , 1 ) ; if ( tid == 0 ) { GPS ( & ( dw -> rtm ) ,
i_pnufqmhe02 , o_B_1_1 , o_o_B_1_2 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ;
m0dbzcjsqp ( & ( dw -> rtm ) , o_o_B_1_2 , & ( dw -> rtdw ) ) ; } } static
...
, 1 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 3 ) ) return
...
, 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 2 ) ) return ; if ( !
...
mr_GPS_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S , 3 ) ;
...
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( nr2eaj2q25j ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { nr2eaj2q25j * dw = (
nr2eaj2q25j * ) ssGetDWork ( S , 0 ) ; ssNonContDerivSigFeedingOutports
...
d4ivgnmxvi ( S , mr_nonContOutputArray , slmrGetTopTidFromMdlRefChildTid ( S
...
#define MDL_START
static void mdlStart ( SimStruct * S ) { nr2eaj2q25j * dw = ( nr2eaj2q25j * )
ssGetDWork ( S , 0 ) ; mdlProcessParameters ( S ) ; osvgy05dkr ( & ( dw ->
rtdw ) ) ; } static void mdlOutputs ( SimStruct * S , int_T tid ) {
nr2eaj2q25j * dw = ( nr2eaj2q25j * ) ssGetDWork ( S , 0 ) ; real_T const *
i_pnufqmhe02 = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T * o_B_1_1
= ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_o_B_1_2 = (
real_T * ) ssGetOutputPortSignal ( S , 1 ) ; if ( tid == PARAMETER_TUNING_TID
) { GPSTID2 ( ) ; } if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID )
{ if ( ssIsSampleHit ( S , 0 , tid ) || ssIsMinorTimeStep ( S ) ) { GPS ( & (
dw -> rtm ) , i_pnufqmhe02 , o_B_1_1 , o_o_B_1_2 , & ( dw -> rtb ) , & ( dw
-> rtdw ) ) ; } } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { nr2eaj2q25j * dw = (
nr2eaj2q25j * ) ssGetDWork ( S , 0 ) ; real_T * o_o_B_1_2 = ( real_T * )
ssGetOutputPortSignal ( S , 1 ) ; if ( ssIsSampleHit ( S , 0 , tid ) ) {
m0dbzcjsqp ( & ( dw -> rtm ) , o_o_B_1_2 , & ( dw -> rtdw ) ) ; } return ; }
static void mdlTerminate ( SimStruct * S ) { nr2eaj2q25j * dw = ( nr2eaj2q25j
* ) ssGetDWork ( S , 0 ) ; kkeqbftsbv ( & ( dw -> rtm ) ) ; return ; }
